...
const aboutMeTextContent =
  "Sou um graduando em Análise de Sistemas; programador com alguns projetos; tenho interesse em linguagem da programação e resolução de problemas.";
...
formInputs.forEach((input) => {
  input.addEventListener("focus", () => {
    ...
    setTimeout(() => {
      formHeading.textContent = `Seu ${input.placeholder}`;
  ...
  input.addEventListener("blur", () => {
    formHeading.style.opacity = "0";
    setTimeout(() => {
      formHeading.textContent = "Vamos Conversar!";
      formHeading.style.opacity = "1";
    }, 300);
  });
});
